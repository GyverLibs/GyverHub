...
Система управления устройством на esp8266/esp32 с конструктором веб-интерфейса:
- Обнаружение устройств в локальной сети и через Интернет (MQTT)
- Отображение списка устройств с доступом к каждому
- Управление устройством из приложения или сайта GyverHUB
- Удобная интеграция в системы умных домов через MQTT
- Простая сборка графического интерфейса прямо в скетче
- Минимальный сетевой трафик, максимально быстрая работа
- Удобный парсинг действий
- Библиотека очень лёгкая и не требует загрузки файлов в FS
- Безопасность и независимость (GyverHUB работает в браузере, своего сервера у него нет)
- 20+ активных элементов интерфейса (кнопки, слайдеры, выбор, оформление, навигация...)
- Файловый менеджер, информация о плате и многое другое
