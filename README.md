...
|⚠️⚠️⚠️<br>**ПЛАНИРУЕТСЯ КРУПНОЕ ОБНОВЛЕНИЕ С СИЛЬНЫМ НАРУШЕНИЕМ СОВМЕСТИМОСТИ. СЛЕДИТЕ ЗА НОВОСТЯМИ! [ТУТ ИНСТРУКЦИЯ](https://github.com/GyverLibs/GyverHub/issues/43) [ТУТ ВЕРСИЯ САЙТА v0.51](https://hub.gyver.ru/old/)**<br>⚠️⚠️⚠️|
| --- |
...
|⚠️⚠️⚠️<br>**Бета-версия! Проект пока что тестируется, следите за коммитами. Известные проблемы, особенности версии, обсуждение, предложения, баги - всё [вот тут](https://github.com/GyverLibs/GyverHub/issues/6) и в [Телеграм чате](https://t.me/AlexGyverChat/441438)**<br>⚠️⚠️⚠️|
| --- |
...
- Локально с компьютера, для этого нужно [скачать сайт](https://github.com/GyverLibs/GyverHub/blob/8356e8bdb4f418b31f4e903eeda6d1fce664cd74/web/local/GyverHub.html) (правой кнопкой - *сохранить ссылку как*) и открыть его в браузере
