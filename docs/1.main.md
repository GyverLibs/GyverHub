...
<details>
<summary>Типы данных, условные обозначения</summary>
...
#define GH_NO_STREAM    // поддержка Stream
#define GH_NO_LOCAL     // поддержка HTTP обнаружение и WebSocket
#define GH_NO_MQTT      // MQTT
#define GH_NO_FS        // работа с файлами (включая ОТА!)
#define GH_NO_INFO      // модуль информация о системе
#define GH_NO_OTA       // ОТА файлом с сайта
