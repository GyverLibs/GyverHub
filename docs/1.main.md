...
bool beginRow(uint8_t width = 0, Text label = "", Color color = Colors::Default);

// закончить строку
void endRow();

// закончить и начать строку
bool nextRow(uint8_t width = 0, Text label = "", Color color = Colors::Default);

// столбец
// начать столбец. Всегда возвращает true
bool beginCol(uint8_t width = 0, Text label = "", Color color = Colors::Default);

// закончить и начать столбец
bool nextCol(uint8_t width = 0, Text label = "", Color color = Colors::Default);

// закончить столбец
void endCol();

// спойлер
bool beginSpoilerRow(uint8_t width = 0, Text label = "", Color color = Colors::Default);
void endSpoilerRow();
bool nextSpoilerRow(uint8_t width = 0, Text label = "", Color color = Colors::Default);

bool beginSpoilerCol(uint8_t width = 0, Text label = "", Color color = Colors::Default);
bool nextSpoilerCol(uint8_t width = 0, Text label = "", Color color = Colors::Default);
void endSpoilerCol();

// пустой виджет, можно использовать как отстум
void Space(uint16_t width = 1, uint16_t height = 1);

// начать кастомный контейнер
bool beginRow(Text wtype, uint16_t width = 0, Text label = "", Color color = Colors::Default);
bool beginCol(Text wtype, uint16_t width = 0, Text label = "", Color color = Colors::Default);

// следующий кастомный контейнер
bool nextRow(Text wtype, uint16_t width = 0, Text label = "", Color color = Colors::Default);
bool nextCol(Text wtype, uint16_t width = 0, Text label = "", Color color = Colors::Default);

// закончить любой контейнер
void endContainer();

// объекты контейнеров
Row(Builder& b, uint16_t width = 0, Text label = "", Color color = Colors::Default);
Col(Builder& b, uint16_t width = 0, Text label = "", Color color = Colors::Default);
SpoilerRow(Builder& b, uint16_t width = 0, Text label = "", Color color = Colors::Default);
SpoilerCol(Builder& b, uint16_t width = 0, Text label = "", Color color = Colors::Default);
