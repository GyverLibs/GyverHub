...
## Зависимости
Для работы GyverHub необходимы дополнительные библиотеки. Для всех платформ:
...
Дополнительно для esp8266/esp32 (для встроенной связи по ws и mqtt):
...
```
Иконки *Font Awesome v6 Solid*, бесплатный пак:
- [Список иконок](https://fontawesome.com/v6/search?o=r&m=free&s=solid)
